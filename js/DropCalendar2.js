...
function RenderCal()
{
 ...
 { 
  try
  {
   Cal.elem = document.createElement('<div id="cal" style="position:absolute; top:275px; left:630px; z-index:1; width:200px; height:0px;"></div>');
  }
  catch(err)
  {
   ...
   Cal.elem.setAttribute("style","position:absolute; top:255px; left:600px; z-index:1; width:200px; height:0px;");
  }
 }
