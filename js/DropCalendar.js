...
function RenderCal()
{
 ...
 { 
  try
  {
   Cal.elem = document.createElement('<div id="cal" style="position:absolute; top:175px; left:1030px; z-index:1; width:200px; height:0px;"></div>');
  }
  catch(err)
  {
   ...
   Cal.elem.setAttribute("style","position:absolute; top:175px; left:1030px; z-index:1; width:200px; height:0px;");
  }
 }
