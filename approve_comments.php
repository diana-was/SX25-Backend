...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%" class="tablePop">
	<tr>
		<td align="left" valign="top"><span class="txtHdr">Unapproved Comments</span></td>
...
<form action="/approve_comments.php" method="POST" name="data_table" id="data_table"  enctype="application/x-www-form-urlencoded">
<div id="tableData">
<table width="100%" border="0" cellspacing="1" cellpadding="0" id="dt1" class="dataTable">
	...
	<td align="center" class="cellHdr"  style="width:60%"><a>Content</a></td>
	...
	<td align="center" class="cellHdr"><a>Date</a></td>
                ...
                <?php
$totalNum = 0;
$pResults = $comment->list_comments(0);
foreach ($pResults as $pRow) 
{
    ...
    <tr class="alter1">
        ...
        <td align="left" valign="middle" width="60%"><?php echo $pRow['comment_content'];?></td>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td align="left">
		<input type="radio" name="action" value="move_comments"> Move selected comments to stored section
		</td>
	</tr>
	<tr>
