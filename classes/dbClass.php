...
{
   protected $last_error;         // holds the last error. Usually mysql_error()
   protected $last_query;         // holds the last query executed.
   protected $row_count;          // holds the last number of rows from a select
